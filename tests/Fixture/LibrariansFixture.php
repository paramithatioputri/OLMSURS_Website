 ...
 * LibrariansFixture
 */
class LibrariansFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'account_status' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['librarian_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'librarian_id' => '5d3a0697-ca9b-4f10-bded-266c756fe0d6',
                ...
                'date_of_birth' => '2020-06-30',
                'gender' => 'Lore',
                'date_created' => '2020-06-30',
                'last_modified' => '2020-06-30',
            ],
        ];
        parent::init();
    }
